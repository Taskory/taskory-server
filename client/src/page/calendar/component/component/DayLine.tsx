...
export const DayLine: React.FC<DayProps> = ({ day, events }) => {
    ...
    return (
        <div className={`border overflow-hidden relative flex-col h-full grid`}>
            <div className="text-left ml-2 mt-1 h-full row-span-1">{day}</div>
            <div
                className={`overflow-hidden h-full flex flex-col-reverse mb-1 lg:row-span-${maxItemLength + 1} row-span-${maxItemLength + 1}`}>
